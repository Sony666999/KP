...
!function() {
    ...
    t.onload = function() {
        VK.Retargeting.Init("VK-RTRG-1797651-e7bXe"),
        VK.Retargeting.Hit()
    }
    ,
...
t_onReady(function() {
    t_onFuncLoad('t_menuburger_init', function() {
        t_menuburger_init('628469864');
    });
});

t_onReady(function() {
    var rec = document.querySelector('#rec628469864');
    if (!rec)
        return;
    rec.setAttribute('data-animationappear', 'off');
    rec.style.opacity = 1;
    t_onFuncLoad('t450_initMenu', function() {
        t450_initMenu('628469864');
    });
});
...
t_onReady(function() {
    var rec = document.getElementById('rec628415656');
    if (!rec)
        return;
...
t_onReady(function() {
    var rec = document.getElementById('rec811101427');
    if (!rec)
        return;
    var firstButton = rec.querySelectorAll('.t-btn[data-btneffects-first], .t-submit[data-btneffects-first]');
    Array.prototype.forEach.call(firstButton, function(button) {
...
t_onReady(function() {
    var rec = document.getElementById('rec628422750');
    if (!rec)
        return;
    var firstButton = rec.querySelectorAll('.t-btn[data-btneffects-first], .t-submit[data-btneffects-first]');
    Array.prototype.forEach.call(firstButton, function(button) {
...
t_onReady(function() {
    var rec = document.getElementById('rec683181881');
    if (!rec)
        return;
    var firstButton = rec.querySelectorAll('.t-btn[data-btneffects-first], .t-submit[data-btneffects-first]');
    Array.prototype.forEach.call(firstButton, function(button) {
...
t_onReady(function() {
    t_onFuncLoad('t_social_init', function() {
        t_social_init('633685988', 't-persons');
    });
});
...
t_onReady(function() {
    t_onFuncLoad('t509_setHeight', function() {
        window.addEventListener('resize', t_throttle(function() {
            t509_setHeight('628419357');
        }));
        t509_setHeight('628419357');
        var rec = document.querySelector('#rec628419357');
        if (!rec)
            return;
...
t_onReady(function() {
    ...
    function t_map_lazyload_add_map() {
        ...
        var rec = document.getElementById('rec' + 628423522);
        if (!rec)
            return;
        ...
        if (window.pageYOffset > blockTop - windowHeight - scrollDiffHeigth) {
            if (map.getAttribute('data-maplazy-load') === 'false') {
                ...
                t_onFuncLoad('t_appendYandexMap', function() {
                    t_appendYandexMap("628423522", "86a82859-ab97-4890-b4cd-7963c119c39b");
                });
            }
        }
    }
...
setTimeout(function() {
    ...
    )(document, window, '2842f19ef9b2eea22eaddb927df8e90e', 'script', 'https://static.tildacdn.com/js/tilda-stat-1.0.min.js');
}, 2000);
